...
function Socials(props) {
  return (
    <SocialsHolder>
      <SocialsHalf>
        <SocialsEach modeStatus={props.modeStatus}>
          <LocationLogo fill={props.modeStatus === true ? "#FFF" : "#4B6A9B"} />
          <p>
            {props.info.location === null
              ? "Not Available"
              : props.info.location}
          </p>
        </SocialsEach>
        <SocialsEach modeStatus={props.modeStatus}>
          <BioLogo fill={props.modeStatus === true ? "#FFF" : "#4B6A9B"} />
          <p>{props.info.blog === "" ? "Not Available" : props.info.blog}</p>
        </SocialsEach>
      </SocialsHalf>
      <SocialsHalf>
        <SocialsEach modeStatus={props.modeStatus}>
          <TwitterLogo fill={props.modeStatus === true ? "#FFF" : "#4B6A9B"} />
          <p>
            {props.info.twitter_username === null
              ? "Not Available"
              : props.info.twitter_username}
          </p>
        </SocialsEach>
        <SocialsEach modeStatus={props.modeStatus}>
          <CompanyLogo fill={props.modeStatus === true ? "#FFF" : "#4B6A9B"} />
          <p>
            {props.info.company === null ? "Not Available" : props.info.company}
          </p>
        </SocialsEach>
      </SocialsHalf>
    </SocialsHolder>
